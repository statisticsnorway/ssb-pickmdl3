...
on the default `automodel`. The package further includes functionality for seasonal adjustment of multiple time series based on a data frame with model specifications. 
