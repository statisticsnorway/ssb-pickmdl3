...
[rjd3x13](https://CRAN.R-project.org/package=rjd3x13). It enables the
`x13` function in `rjd3x13` to be run with the `pickmdl` model selection
procedure. The `pickmdl` selection procedure differs from the default
